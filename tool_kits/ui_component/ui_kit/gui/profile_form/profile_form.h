...
public:
    ...
    static ProfileForm* ShowProfileForm(UTF8String uid, nim::NIMTeamUserType obj_type);
    ...
    static ProfileForm* ShowProfileForm(UTF8String tid, UTF8String uid, nim::NIMTeamUserType my_type, nim::NIMTeamUserType obj_type);
