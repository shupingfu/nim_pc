...
public:
    ...
    /** @fn void GetMentionedMeMessages(const QChatGetMentionedMeMessagesParam& param)
    ...
    /** @fn void AreMentionedMeMessages(const QChatAreMentionedMeMessagesParam& param)
     * @brief 查询消息是否 @ 当前用户
     * @since v9.9.0
