...
struct NIM_QCHAT_SDK_CPPWRAPPER_DLL_API QChatServerGetServersResp {
    ...
    uint32_t res_code{0};
    /// 服务器列表
    std::vector<QChatServerInfo> server_list{};
...
struct NIM_QCHAT_SDK_CPPWRAPPER_DLL_API QChatServerGetMembersResp {
    ...
    uint32_t res_code{0};
    /// 成员信息列表
    std::vector<QChatMemberInfo> member_list{};
...
struct NIM_QCHAT_SDK_CPPWRAPPER_DLL_API QChatServerGetBannedMembersPageResp {
    ...
    QChatPageInfo page_info{};
    /// 成员封禁列表
    std::vector<QChatMemberBanInfo> ban_list{};
...
struct NIM_QCHAT_SDK_CPPWRAPPER_DLL_API QChatServerEnterAsVisitorResp {
    /// 操作结果, 参考NIMResCode
    uint32_t res_code{0};
    /// 失败列表
    std::vector<uint64_t> failed_servers{};
    QChatServerEnterAsVisitorResp() = default;
    ...
    NIMQChatServerEnterAsVisitorResp ToCParam() const {
        NIMQChatServerEnterAsVisitorResp c_resp;
        c_resp.res_code = res_code;
        c_resp.failed_servers = const_cast<uint64_t*>(failed_servers.data());
        c_resp.failed_servers_count = failed_servers.size();
        return c_resp;
...
struct NIM_QCHAT_SDK_CPPWRAPPER_DLL_API QChatServerLeaveAsVisitorResp {
    /// 操作结果, 参考NIMResCode
    uint32_t res_code{0};
    /// 失败列表
    std::vector<uint64_t> failed_servers{};
    QChatServerLeaveAsVisitorResp() = default;
    ...
    NIMQChatServerLeaveAsVisitorResp ToCParam() const {
        NIMQChatServerLeaveAsVisitorResp c_resp;
        c_resp.res_code = res_code;
        c_resp.failed_servers = const_cast<uint64_t*>(failed_servers.data());
        c_resp.failed_servers_count = failed_servers.size();
        return c_resp;
...
struct NIM_QCHAT_SDK_CPPWRAPPER_DLL_API QChatServerSubscribeAsVisitorResp {
    /// 操作结果, 参考NIMResCode
    uint32_t res_code{0};
    /// 失败列表
    std::vector<uint64_t> failed_servers{};
    QChatServerSubscribeAsVisitorResp() = default;
    ...
    NIMQChatServerSubscribeAsVisitorResp ToCParam() const {
        NIMQChatServerSubscribeAsVisitorResp c_resp;
        c_resp.res_code = res_code;
        c_resp.failed_servers = const_cast<uint64_t*>(failed_servers.data());
        c_resp.failed_servers_count = failed_servers.size();
        return c_resp;
...
struct NIM_QCHAT_SDK_CPPWRAPPER_DLL_API QChatServerEnterAsVisitorParam {
    /// 回调函数
    ...
    QChatServerEnterAsVisitorParam(const NIMQChatServerEnterAsVisitorParam& c_param) {
        ...
        cb = [c_callback = c_param.cb, user_data = c_param.user_data](const QChatServerEnterAsVisitorResp& response) {
            auto c_response = response.ToCParam();
            c_response.user_data = user_data;
            c_callback(&c_response);
        };
    ...
    NIMQChatServerEnterAsVisitorParam ToCParam() const {
        auto cb_holder = new ServerEnterAsVisitorCallback(cb);
        NIMQChatServerEnterAsVisitorParam param = {};
        param.user_data = cb_holder;
        param.cb = [](const NIMQChatServerEnterAsVisitorResp* resp) {
            InvokeCallback<ServerEnterAsVisitorCallback, NIMQChatServerEnterAsVisitorResp>(resp);
        };
        param.server_ids_count = server_ids.size();
        param.server_ids = const_cast<uint64_t*>(server_ids.data());
        return param;
...
struct NIM_QCHAT_SDK_CPPWRAPPER_DLL_API QChatServerLeaveAsVisitorParam {
    /// 回调函数
    ...
    QChatServerLeaveAsVisitorParam(const NIMQChatServerLeaveAsVisitorParam& c_param) {
        ...
        cb = [c_callback = c_param.cb, user_data = c_param.user_data](const QChatServerLeaveAsVisitorResp& response) {
            auto c_response = response.ToCParam();
            c_response.user_data = user_data;
            c_callback(&c_response);
        };
    ...
    NIMQChatServerLeaveAsVisitorParam ToCParam() const {
        auto cb_holder = new ServerLeaveAsVisitorCallback(cb);
        NIMQChatServerLeaveAsVisitorParam param = {};
        param.user_data = cb_holder;
        param.cb = [](const NIMQChatServerLeaveAsVisitorResp* resp) {
            InvokeCallback<ServerLeaveAsVisitorCallback, NIMQChatServerLeaveAsVisitorResp>(resp);
        };
        param.server_ids_count = server_ids.size();
        param.server_ids = const_cast<uint64_t*>(server_ids.data());
        return param;
...
struct NIM_QCHAT_SDK_CPPWRAPPER_DLL_API QChatServerSubscribeAsVisitorParam {
    /// 回调函数
    ServerSubscribeAsVisitorCallback cb{nullptr};
    /// 操作类型
    NIMQChatSubscribeOpeType ope_type{kNIMQChatSubscribeOpeTypeSubscribe};
    /// ID 列表
    std::vector<uint64_t> server_ids{};
    QChatServerSubscribeAsVisitorParam() = default;
    QChatServerSubscribeAsVisitorParam(const NIMQChatServerSubscribeAsVisitorParam& c_param) {
        ...
        cb = [c_callback = c_param.cb, user_data = c_param.user_data](const QChatServerSubscribeAsVisitorResp& response) {
            auto c_response = response.ToCParam();
            c_response.user_data = user_data;
            c_callback(&c_response);
        };
    ...
    NIMQChatServerSubscribeAsVisitorParam ToCParam() const {
        auto cb_holder = new ServerSubscribeAsVisitorCallback(cb);
        NIMQChatServerSubscribeAsVisitorParam param = {};
        param.user_data = cb_holder;
        param.cb = [](const NIMQChatServerSubscribeAsVisitorResp* resp) {
            InvokeCallback<ServerSubscribeAsVisitorCallback, NIMQChatServerSubscribeAsVisitorResp>(resp);
        };
        param.ope_type = ope_type;
        param.sub_type = sub_type;
        param.server_ids_count = server_ids.size();
    ...
    // 以下字段为内部使用
    NIMQChatSubscribeType sub_type{kNIMQChatSubscribeTypeVisitorServerNotification};
};
