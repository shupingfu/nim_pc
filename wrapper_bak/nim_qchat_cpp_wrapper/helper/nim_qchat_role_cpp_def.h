...
/// @struct QChatPermission, key NIMQChatPermissions
...
protected:
    ...
    mutable std::vector<std::vector<NIMQChatRoleInfo>> c_role_info_of_members_;
};
...
struct NIM_QCHAT_SDK_CPPWRAPPER_DLL_API QChatCheckPermissionsResp {
    ...
    NIMQChatCheckPermissionsResp ToCParam() const {
        ...
        c_response.permissions = permissions_.data();
        c_response.options = const_cast<NIMQChatPermissionsOption*>(options_.data());
        return c_response;
    }

protected:
    mutable std::vector<uint32_t> permissions_;
...
struct NIM_QCHAT_SDK_CPPWRAPPER_DLL_API QChatCheckPermissionParam {
    ...
    uint64_t channel_id{0};
    /// 查询的权限
    uint32_t permission{kPermissionManageServer};
...
struct NIM_QCHAT_SDK_CPPWRAPPER_DLL_API QChatCheckPermissionsParam {
    ...
    NIMQChatCheckPermissionsParam ToCParam() const {
        ...
        c_param.permissions = const_cast<uint32_t*>(permissions.data());
