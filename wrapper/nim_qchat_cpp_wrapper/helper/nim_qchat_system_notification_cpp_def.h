...
/// @struct QChatSystemNotificationDataChannelVisitorVisibilityChange 系统消息为频道游客可见性变更
struct NIM_QCHAT_SDK_CPPWRAPPER_DLL_API QChatSystemNotificationDataChannelVisitorVisibilityChange : QChatSystemNotificationDataBase {
    /// 频道游客可见性
    bool visible{true};
...
static std::map<NIMQChatSystemNotificationType, std::function<std::shared_ptr<QChatSystemNotificationDataBase>(void*)>> msg_data_transform_map_{
    ...
    {kNIMQChatSystemNotificationTypeChannelVisitorVisibilityChange, MsgDataCPPToC<QChatSystemNotificationDataChannelVisitorVisibilityChange, NIMQChatSystemNotificationDataChannelVisitorVisibilityChange>},
};
// clang-format on
