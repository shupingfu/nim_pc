...
public:
    ...
    /** @fn void EnterAsVisitor(const QChatServerEnterAsVisitorParam& param)
     * 以游客身份进入服务器
     * @param[in] param 接口参数
     * @return void
     */
    static void EnterAsVisitor(const QChatServerEnterAsVisitorParam& param);

    /** @fn void LeaveAsVisitor(const QChatServerLeaveAsVisitorParam& param)
     * 以游客身份离开服务器
     * @param[in] param 接口参数
     * @return void
     */
    static void LeaveAsVisitor(const QChatServerLeaveAsVisitorParam& param);
    ...
    /** @fn void SubscribeAsVisitor(const QChatServerSubscribeAsVisitorParam& param)
     * 以游客身份订阅服务器相关信息
     * @param[in] param 接口参数
     * @return void
     */
    static void SubscribeAsVisitor(const QChatServerSubscribeAsVisitorParam& param);
