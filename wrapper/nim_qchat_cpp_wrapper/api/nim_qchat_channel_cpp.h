...
public:
    ...
    /** @fn void SubscribeAsVisitor(const QChatChannelSubscribeAsVisitorParam& param)
     * 以游客身份订阅未读状态、未读数或未读消息、事件
     * @param[in] param 接口参数
     * @return void
     */
    static void SubscribeAsVisitor(const QChatChannelSubscribeAsVisitorParam& param);
